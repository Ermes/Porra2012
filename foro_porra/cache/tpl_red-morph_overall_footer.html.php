...
<div id="page-footer">
	...
	<div class="navbar">
		...
		<ul class="linklist">
			<li class="icon-home">&nbsp;<a href="<?php echo (isset($this->_rootref['U_INDEX'])) ? $this->_rootref['U_INDEX'] : ''; ?>" accesskey="h"><b><?php echo ((isset($this->_rootref['L_INDEX'])) ? $this->_rootref['L_INDEX'] : ((isset($user->lang['INDEX'])) ? $user->lang['INDEX'] : '{ INDEX }')); ?></b></a></li>
...
//-->
	...
	<div class="copyright">Powered by <a target="_blank" href="http://www.phpbb.com/">phpBB</a> &copy; 2000, 2002, 2005, 2007 phpBB Group
    <div class="copyright">Red Morph :: <a target="_blank" href="http://www.pc-morph.com/">Designs By Morph</a> :: &copy; 2007 Morph
