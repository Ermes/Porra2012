...
75149
a:1:{i:0;a:11:{s:8:"style_id";s:1:"6";s:8:"theme_id";s:1:"6";s:10:"theme_data";s:74751:"/*  phpBB 3.0 Style Sheet
    --------------------------------------------------------------
	Style name:		red_morph
	Based on style:	proSilver (this is the default phpBB 3 style)
	Original author:	subBlue ( http://www.subBlue.com/ )
	Modified by: Morph www.pc.morph.com		
...
h3 {
	border-bottom-color: #7E1F07;
	color: #7E1F07;
}

hr {
	border-color: #FFFFFF;
	border-top-color: #7E1F07;
}
...
.bg1	{ background-color: #FFE8BE; }
.bg2	{ background-color: #FFC994;  }
.bg3	{ background-color: #FFBA6C; }
...
a:link	{ color: #7E1F07; }
a:visited	{ color: #7E1F07; }
a:hover	{ color:  #A3C71B; }
...
/* a.forumtitle:visited { color: #264273; } */
...
/* a.topictitle:visited { color: #5176B7; } */
...
/*  phpBB 3.0 Style Sheet
   ...
   Based on style:      proSilver (this is the default phpBB 3 style)
   Original author:   subBlue ( http://www.subBlue.com/ )
   Modified by:      thedawn2009 (mikel_man, Barrys)
...
.top-left { 
   background-image: url("{T_THEME_PATH}/images/borders/corners_top.gif"); background-repeat:no-repeat; /* CHANGE: path and name of your image */
...
.top-center { 
   background-image: url("{T_THEME_PATH}/images/borders/bg_headers.gif"); /* CHANGE: path and name of your image */
...
.bottom-left  { 
   background-image: url("{T_THEME_PATH}/images/borders/corners_bottom.gif"); background-repeat:no-repeat; /* CHANGE: path and name of your image */
   background-position: 0 0px; /* CHANGE: replace second number by negative height of one of your corners */
...
.bottom-center { 
   background-image: url("{T_THEME_PATH}/images/borders/bg_footers.gif"); /* CHANGE: path and name of your image */
   background-position: 0 0px; /* CHANGE: replace second number by negative height of one of your corners */
   height: 20px;       /* CHANGE: replace by the height of one of your corners (= 1/2 height of the image) */
   weidth: 20px;       /* CHANGE: replace by the height of one of your corners (= 1/2 height of the image) */
   font-size: 2px;    /* DNC: correction IE for height of the <div>'s */
...
.inside {
   ...
   color: #C34815;                 /* YCC: default text-color of the inside */
   padding-left: 0px;              /* YCC: all texts at some distance of the left border */
   padding-right: 0px;             /* YCC: all texts at some distance of the right border */
   background-image: url("{T_THEME_PATH}/images/borders/bg_body.gif"); /* CHANGE: path and name of your image */
   }
...
";s:10:"theme_path";s:9:"red_morph";s:10:"theme_name";s:9:"red_morph";s:11:"theme_mtime";s:10:"1274913944";s:11:"imageset_id";s:1:"6";s:13:"imageset_name";s:9:"red_morph";s:18:"imageset_copyright";s:29:"&copy; Designs Pc-Morph, 2007";s:13:"imageset_path";s:9:"red_morph";s:13:"template_path";s:9:"red_morph";}}