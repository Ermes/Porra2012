...
// Disallow Usernames
$lang = array_merge($lang, array(
	'ACP_DISALLOW_EXPLAIN'	=> 'Aquí puede controlar qué nombres de usuario no se permitirá que sean utilizados. Nombres de usuario deshabilitados pueden contener un comodín (*).  Por favor observe que no puede especificar un nombre de usuario que ya haya sido registrado, primero ha de borrar ese nombre y después deshabilitarlo',
	...
	'DISALLOWED_ALREADY'		=> 'El nombre que ingresó no puede ser deshabilitado. O bien ya existe en la lista, o bien existe en la lista de palabras censuradas, o ha sido registrado previamente.',
