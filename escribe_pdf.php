...
/******************************/
function PDF_escribe_cabecera ($pdf, $datos_porra, $impresa) {
// Dibujamos el logo de la porra
//$pdf->SetXY (10, 10);
//$pdf->SetFont('Arial','',20);
//$pdf->Cell (190, 20, "Aquí va la imagen de la porra", 1, 0, 'C');
$pdf->Image ('imagenes/logo_cabecera.gif',10 ,10 , 190, '', 'GIF');
$pdf->Image ('imagenes/logo_gota_agua.jpg',10 ,60 , 190, '', 'JPG');
...
$pdf->Cell (190, 10, "Esta es su apuesta. Imprímala por duplicado y fírmela.", 0, 0, 'C');
